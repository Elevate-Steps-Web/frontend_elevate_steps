...
export default function TitleCard({
  ...
  return (
    <div className="flex flex-col justify-center h-72 w-[25rem] border-2 border-grey-500 hover:border-green rounded-lg transition duration-200 ease-in-out hover:scale-110">
      <div className="absolute flex flex-row z-20 h-72 w-[25rem]">
      ...
      <div className="absolute bg-primary-blue z-0 opacity-30 h-[17.8rem] w-[24.8rem] rounded-md" />
      {mediaType === 'image' && (
        <AdvancedImage
